...
if (isset($_GET['deleteAlbumBtn']) && isset($_GET['album_id'])) {
    $albumId = $_GET['album_id'];
    $username = $_SESSION['username'];  // Get the logged-in username
    
    // Call the deleteAlbum function with the correct arguments
    $isDeleted = deleteAlbum($pdo, $albumId, $username);
    ...
    if ($isDeleted) {
        ...
        // Handle error, e.g., album not found or user doesn't have permission
        echo "Error: Unable to delete the album.";
    }
}